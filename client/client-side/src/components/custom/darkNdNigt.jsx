...
// const CustomIcon = ({ colorMode = 'light', className = '', onClick }) => {
//   const fillColor = colorMode === 'dark' ? '#ffffff' : '#000000'; // Fill color based on mode
