                ...
                <div className="max-w-lg bg-[#1F2937] drop-shadow-md rounded-md text-white" key={index}>
                  ...
                  <div className="p-4 justify-between flex-col">
                    <div className="mt-4 flex flex-col gap-2">
                      ...
                      <p className="px-4 text-sm text-white font-Rubik border-l-4 text-balance border-white drop-shadow-md mb-6">
                        {club.description}
                      </p>
                    </div>
                        ...
                        <button
                          ...
                          className="text-white px-5 rounded-md font-new-amsterdam bg-[#0D9488] border-white shadow-md border-[1px]">
                          Join
                        </button>
